import '../../css/b-friend/b-friend-price-grid.css'

function BfriendPricegrid() {

  return (
    <section
      className="container-fluid section d-flex g-0 z-index-0"
      id="b-friend-pricing-plans"
    >
      <div className="row col-8 d-grid b-friend-price-grid">
...
export default BfriendPricegrid;
