            ...
            <div className="row col-lg-9 col-md-12 d-flex pricing-price-grid-sec">
                ...
                <div className="pricing-price-grid-main-container d-grid">
                    {/* Header Row */}
                        ...
                        <div className="col price-header" id='pricing-price-grid-gold'>
                            <div className="pricing-card gold text-center p-4 rounded-4">
                        ...
                        <div className="col price-header" id='pricing-price-grid-platinum'>
                            <div className="pricing-card platinum text-center p-4 rounded-4">
                        ...
                        <div className="col price-header" id='pricing-price-grid-elite'>
                            <div className="pricing-card elite text-center p-4 rounded-4">
                    ...
                    {/* Tutor Achievements Row */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Tutor Achievements and Experience</h4>
                        </div>
                        <div className="col feature-content" id='pricing-price-grid-gold'>
                        ...
                        <div className="col feature-content" id='pricing-price-grid-platinum'>
                        ...
                        <div className="col feature-content"  id='pricing-price-grid-elite'>
                    ...
                    {/* Tutor Selection Criteria Row */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Tutor Selection Criteria</h4>
                        </div>
                        <div className="col feature-content" id='pricing-price-grid-gold'>
                        ...
                        <div className="col">
                            <div className="feature-content" id='pricing-price-grid-elite'>
                    ...
                    {/* Additional Features Section */}
                        <div className="p-3 d-flex">
                            <h4 className="feature-title">Additional Features</h4>
                        </div>
                        <div className="text-center feature-content" id='pricing-price-grid-gold'>
                            <span className="check gold-check">✓</span>
                        </div>
                        <div className="text-center feature-content" id='pricing-price-grid-platinum'>
                            <span className="check platinum-check">✓</span>
                        </div>
                        <div className="text-center feature-content"  id='pricing-price-grid-elite'>
                            <span className="check elite-check">✓</span>
                        </div>

                    {/* Progress Reports */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Progress Reports</h4>
                        </div>
                        <div className="col text-center feature-content"  id='pricing-price-grid-gold'>
                            <span className="check gold-check">✓</span>    
                        </div>
                        <div className="col text-center feature-content" id='pricing-price-grid-platinum'>
                                <span className="check platinum-check">✓</span> 
                        </div>
                        <div className="col text-center feature-content"  id='pricing-price-grid-elite'>
                                <span className="check elite-check">✓</span>
                        </div>

                    {/* Parent consultations */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Parent consultations</h4>
                        </div>
                        <div className="col text-center feature-content" id='pricing-price-grid-gold'>
                            <span className="check gold-check">✓</span>    
                        </div>
                    ...
                    {/* 24/7 support */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">24/7 support via Platform</h4>
                        </div>
                        <div className="col text-center feature-content" id='pricing-price-grid-gold'>
                            <span className="check gold-check">✓</span>   
                        </div>
                    ...
                    {/* Medicine/Dentistry Interview */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Medicine/Dentistry Interview Preparation Workshops</h4>
                        </div>
                        <div className="col text-center feature-content" id='pricing-price-grid-gold'>
                            <span className="check gold-check">✓</span>    
                        </div>
                    ...
                    {/* Scholarship Application */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Scholarship Application Support</h4>
                        </div>
                        <div className="col text-center feature-content" id='pricing-price-grid-gold'>
                            <span className="check gold-check">✓</span>    
                        </div>
                    ...
                    {/* University Application */}
                        <div className="p-3 d-flex">
                            <h4 className="feature-title">University Application Support</h4>
                        </div>
                        <div className="-center feature-content" id='pricing-price-grid-gold'>
                            <span className="check gold-check">✓</span>    
                        </div>
                        <div className=" text-center feature-content" id='pricing-price-grid-platinum'>
                            <span className="check platinum-check">✓</span>    
                    ...
                    {/* Mode of Delivery */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Mode of Delivery</h4>
                        </div>
                        <div className="col text-center feature-content"  id='pricing-price-grid-gold'>
                    ...
                    {/* Lesson Style */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Lesson Style</h4>
                        </div>
                        <div className="col text-center feature-content" id='pricing-price-grid-gold'>
                    ...
                    {/* Payments */}
                        <div className="col p-3 d-flex">
                            <h4 className="feature-title">Payments</h4>
                        </div>
                        <div className="col text-center feature-content feture-content-b" id='pricing-price-grid-gold'>
                        <p className="text-muted small">Online, payment following each lesson</p>    
                        </div>
                        <div className="col text-center feature-content feture-content-b" id='pricing-price-grid-platinum'>
                        <p className="text-muted small">Online, payment following each lesson</p>    
                        </div>
                        <div className="col text-center feature-content feture-content-b" id='pricing-price-grid-elite'>
                        <p className="text-muted small">Online, payment following each lesson</p>
                        </div>
                </div>
