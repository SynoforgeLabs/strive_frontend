import "../../css/tutor/tutor-faq.css";

function ContactusFaq() {

    return (
        <section
            className="row container-fluid section d-flex g-0 z-index-0 tutor-faq-main"
            id="tutor-faq-main"
        >
            <div className="row col-9 d-flex tutor-faq-sec">
                <h1 className="fw-bold d-flex tutor-faq-main-h">
                    FAQ
                </h1>

                <div class="accordion d-flex gap-3" id="tutor-faq-accordians-main">
                    <div class="accordion-item" id="tutor-faq-ac-item">
                        <h2 class="accordion-header">
                            <button
                                class="btn primary-button d-flex fw-bold w-100 tutor-faq-q"
                                type="button"
