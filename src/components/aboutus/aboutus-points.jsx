            ...
            <div className="col-8 aboutus-points-sec">
                ...
                <div className="row d-flex ms-xl-6 about-us-point-main" >
                    ...
                    <div className="col-6 d-flex aboutus-point-img-main">
                        <img src="/Images/Aboutus/point1.png" alt="" className="aboutus-point-img" id="aboutus-point1-img"/>
                    </div>
                </div>

                <div className="row d-flex about-us-point-main" >
                    <div className="col-6 d-flex aboutus-point-img-main">
                        <img src="/Images/Aboutus/point2.png" alt="" className="aboutus-point-img" id="aboutus-point2-img"/>
                    </div>
                    <div className="col-6 d-flex about-us-point-con">
                ...
                <div className="row d-flex about-us-point-main" >
                    ...
                    <div className="col-6 d-flex aboutus-point-img-main">
                        <img src="/Images/Aboutus/point3.png" alt="" className="aboutus-point-img" id="aboutus-point3-img"/>
                    </div>
                </div>

                <div className="row d-flex about-us-point-main" >
                    <div className="col-6 d-flex aboutus-point-img-main">
                        <img src="/Images/Aboutus/point4.png" alt="" className="aboutus-point-img" id="aboutus-point4-img"/>
                    </div>
                    <div className="col-6 d-flex about-us-point-con">
                        <h1 className="fw-bold d-flex mb-3 aboutus-point-main-h" id="aboutus-point-r">
                        Learn from the Best 
                ...
                <div className="row d-flex about-us-point-main" >
                    ...
                    <div className="col-6 d-flex aboutus-point-img-main">
                        <img src="/Images/Aboutus/point5.png" alt="" className="aboutus-point-img" id="aboutus-point5-img"/>
                    </div>
                </div>
