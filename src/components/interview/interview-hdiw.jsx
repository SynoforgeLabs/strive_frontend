                    ...
                    <div className="container-fluid interview-hdiw-container">
                        ...
                        <div className="row justify-content-center g-4">
                            <div className="col-12 col-md-3">
                                <div className="card h-100 interview-hdiw-card">
                                    <div className="card-body text-center">
                                        <span className="interview-hdiw-number">1</span>
                                        <p className="interview-hdiw-step-text mb-0">
                            ...
                            <div className="col-12 col-md-3">
                                <div className="card h-100 interview-hdiw-card">
                                    <div className="card-body text-center">
                                        <span className="interview-hdiw-number">2</span>
                                        <p className="interview-hdiw-step-text mb-0">
